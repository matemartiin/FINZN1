...
export class DataManager {
  ...
  getDefaultCategories() {
    return [
      ...
      { id: '3', name: 'Salud', icon: '<i class="ph ph-heart-straight"></i>', color: '#10b981' },
      { id: '4', name: 'Ocio', icon: '<i class="ph ph-game-controller"></i>', color: '#f59e0b' },
      { id: '5', name: 'Supermercado', icon: '<i class="ph ph-shopping-cart"></i>', color: '#84cc16' },
      ...
      { id: '10', name: 'Deportes', icon: '<i class="ph ph-soccer-ball"></i>', color: '#22c55e' },
      { id: '11', name: 'Viajes', icon: '<i class="ph ph-airplane"></i>', color: '#f97316' },
      { id: '12', name: 'PedidosYa', icon: '<img src="/assets/svg/pedidosya-logo.svg" alt="PedidosYa" width="20" height="20" style="display: inline-block;">', color: '#ff6b35' },
