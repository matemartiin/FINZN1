...
export class DataManager {
  ...
  getDefaultCategories() {
    return [
      ...
      { id: '5', name: 'Supermercado', icon: '<i class="ph ph-shopping-cart"></i>', color: '#14b8a6' },
      ...
      { id: '12', name: 'PedidosYa', icon: '<img src="/assets/svg/pedidosya-logo.svg" alt="PedidosYa" width="20" height="20" style="display: inline-block;">', color: '#dc2626' },
